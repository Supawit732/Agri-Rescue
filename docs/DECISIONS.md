...
seed ไม่สร้าง `quality_assessments` เพราะข้อความให้ชั่วโมงที่เหลือ ไม่ได้ให้ผลประเมินอากาศ อากาศสำรองตอนเรียก Open-Meteo ไม่สำเร็จใช้ตามแผน 32°C / 75% ต้นแบบใช้ 34°C / 78% ค่านี้เก็บไว้เทียบใน Phase 2 เท่านั้น ตัวอย่างที่ต้องตรงใน Phase 2 เมื่อ temp 34°C: มะม่วงความสุก 2 ได้ shelfHours 55 และราคาเกรดปกติ 36, ความสุก 3 ได้ shelfHours 37
